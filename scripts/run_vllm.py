...
def generate_slurm_script(args, job_name):
    ...
    # Main script to run
    script_main = "python -m vllm.entrypoints.openai.api_server --model /home/hack-gen1/models/Qwen3-4B-Instruct-2507/ --peft /home/hack-gen1/models/qwen-finetuned-test --tensor-parallel-size 2   --dtype half"
